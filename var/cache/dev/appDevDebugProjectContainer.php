...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'StarStores', 'user' => 'root', 'password' => 'david', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Acme/Bundle/StareStoreBundle/Entity'))), 'Acme\\Bundle\\StareStoreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AcmeBundleStareStoreBundle' => 'Acme\\Bundle\\StareStoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_21be77d6ceac043213cbdd75b1586c5a1b9217f4cd25088399be304a3ef79049');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('base_url', 'http://localhost/Analisis2_Proyecto/web/app_dev.php');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/Bundle/BlogBundle/Resources/views'), 'AcmeBundleBlog');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/Bundle/StareStoreBundle/Resources/views'), 'AcmeBundleStareStore');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0a4343f04cb0232b534a4c829cc4c77b4629f54a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ddc1552d0ac3.29661866')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeBundleBlogBundle' => 'Acme\\Bundle\\BlogBundle\\AcmeBundleBlogBundle',
                'AcmeBundleStareStoreBundle' => 'Acme\\Bundle\\StareStoreBundle\\AcmeBundleStareStoreBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'StarStores',
            'database_user' => 'root',
            'database_password' => 'david',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '0a4343f04cb0232b534a4c829cc4c77b4629f54a',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '0a4343f04cb0232b534a4c829cc4c77b4629f54a',
